...
w = rand((feature_params.template_size / feature_params.hog_cell_size)^2 * 36,1); %placeholder, delete
...
imhog = vl_hog('render', single(reshape(w, [n_hog_cells n_hog_cells 36])), 'verbose','variant','dalaltriggs') ;
